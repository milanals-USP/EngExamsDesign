...
%Define which questions ('perguntas') should be used in this exam. If there is more than one line
%in this variable, each student will received the exam with one of the different set of questions.
v_perguntas=[1 2 3
             1 2 4];
...
for c=1:size(entrada,1)
    for c2=1:size(entrada,2)
        ...
        %select the answers for all questions. Each of the elements here
		%must correspond to the answer for each question in 'enunciados' variable
...
c=1; digitsminimo(c)=4; decimalsresposta(c)=2; sinal{c}='false';margemresposta{c}=0.02;faixaexatoresposta=0.005;toleranciaultimodigito{c}=false;
c=2; digitsminimo(c)=3; decimalsresposta(c)=2; sinal{c}='false';margemresposta{c}=0.02;faixaexatoresposta=0.005;toleranciaultimodigito{c}=false;
c=3; digitsminimo(c)=3; decimalsresposta(c)=2; sinal{c}='false';margemresposta{c}=0.02;faixaexatoresposta=0.005;toleranciaultimodigito{c}=false;
c=4; digitsminimo(c)=5; decimalsresposta(c)=2; sinal{c}='false';margemresposta{c}=0.02;faixaexatoresposta=0.005;toleranciaultimodigito{c}=false;
